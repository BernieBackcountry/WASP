...
utilities.save_dict_to_csv(path_data, {"Satellite": list(lyngsat_data.keys())}, "lyngsat.csv")
...
utilities.save_dict_to_csv(path_data, {"Satellite": altervista_data}, "altervista.csv")
